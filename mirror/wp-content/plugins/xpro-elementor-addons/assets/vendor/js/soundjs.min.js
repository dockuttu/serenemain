 ...
 */
(this.createjs=this.createjs||{}),(function(){var a=(createjs.SoundJS=createjs.SoundJS||{});(a.version="1.0.0"),(a.buildDate="Thu, 12 Oct 2017 16:34:05 GMT")})(),(this.createjs=this.createjs||{}),(createjs.extend=function(a,b){"use strict";function c(){this.constructor=a}
return(c.prototype=b.prototype),(a.prototype=new c())}),(this.createjs=this.createjs||{}),(createjs.promote=function(a,b){"use strict";var c=a.prototype,d=(Object.getPrototypeOf&&Object.getPrototypeOf(c))||c.__proto__;if(d){c[(b+="_")+"constructor"]=d.constructor;for(var e in d)c.hasOwnProperty(e)&&"function"==typeof d[e]&&(c[b+e]=d[e]);}
return a}),(this.createjs=this.createjs||{}),(createjs.deprecate=function(a,b){"use strict";return function(){var c="Deprecated property or method '"+b+"'. See docs for info.";return console&&(console.warn?console.warn(c):console.log(c)),a&&a.apply(this,arguments)}}),(this.createjs=this.createjs||{}),(createjs.indexOf=function(a,b){"use strict";for(var c=0,d=a.length;d>c;c++)if(b===a[c])return c;return-1}),(this.createjs=this.createjs||{}),(function(){"use strict";createjs.proxy=function(a,b){var c=Array.prototype.slice.call(arguments,2);return function(){return a.apply(b,Array.prototype.slice.call(arguments,0).concat(c))}}})(),(this.createjs=this.createjs||{}),(function(){"use strict";function BrowserDetect(){throw "BrowserDetect cannot be instantiated"}
var a=(BrowserDetect.agent=window.navigator.userAgent);(BrowserDetect.isWindowPhone=a.indexOf("IEMobile")>-1||a.indexOf("Windows Phone")>-1),(BrowserDetect.isFirefox=a.indexOf("Firefox")>-1),(BrowserDetect.isOpera=null!=window.opera),(BrowserDetect.isChrome=a.indexOf("Chrome")>-1),(BrowserDetect.isIOS=(a.indexOf("iPod")>-1||a.indexOf("iPhone")>-1||a.indexOf("iPad")>-1)&&!BrowserDetect.isWindowPhone),(BrowserDetect.isAndroid=a.indexOf("Android")>-1&&!BrowserDetect.isWindowPhone),(BrowserDetect.isBlackberry=a.indexOf("Blackberry")>-1),(createjs.BrowserDetect=BrowserDetect)})(),(this.createjs=this.createjs||{}),(function(){"use strict";function EventDispatcher(){(this._listeners=null),(this._captureListeners=null)}
...
if(e[f]==b){1==g?delete d[a]:e.splice(f,1);break}}}),(a.off=a.removeEventListener),(a.removeAllEventListeners=function(a){a?(this._listeners&&delete this._listeners[a],this._captureListeners&&delete this._captureListeners[a]):(this._listeners=this._captureListeners=null)}),(a.dispatchEvent=function(a,b,c){if("string"==typeof a){var d=this._listeners;if(!(b||(d&&d[a])))return!0;a=new createjs.Event(a,b,c)}else a.target&&a.clone&&(a=a.clone());try{a.target=this}catch(e){}
if(a.bubbles&&this.parent){for(var f=this,g=[f];f.parent;)g.push((f=f.parent));var h,i=g.length;for(h=i-1;h>=0&&!a.propagationStopped;h--)g[h]._dispatchEvent(a,1+(0==h));for(h=1;i>h&&!a.propagationStopped;h++)g[h]._dispatchEvent(a,3);}else this._dispatchEvent(a,2);return!a.defaultPrevented}),(a.hasEventListener=function(a){var b=this._listeners,c=this._captureListeners;return!!((b&&b[a])||(c&&c[a]))}),(a.willTrigger=function(a){for(var b=this;b;){if(b.hasEventListener(a))return!0;b=b.parent}
return!1}),(a.toString=function(){return"[EventDispatcher]"}),(a._dispatchEvent=function(a,b){var c,d,e=2>=b?this._captureListeners:this._listeners;if(a&&e&&(d=e[a.type])&&(c=d.length)){try{a.currentTarget=this}catch(f){}
try{a.eventPhase=0|b}catch(f){}(a.removed=!1),(d=d.slice());for(var g=0;c>g&&!a.immediatePropagationStopped;g++){var h=d[g];h.handleEvent?h.handleEvent(a):h(a),a.removed&&(this.off(a.type,h,1==b),(a.removed=!1))}}
